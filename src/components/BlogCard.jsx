        ...
        <div className="col-12 col-md-2 col-lg-3  mb-4">
            <div className="card border-0 shadow-lg">
                ...
                <div className="card-body">
                    ...
                    {/* <p>Lorem, ipsum dt. Natus uis cupiditate eveniet!</p> */}
                    <p>{blog.shortDesc}</p>

                    <div className="d-flex justify-content-between">
                        <Link to="#" className='btn btn-dark'>Details</Link>

                        <Link to="" className='text-dark'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
